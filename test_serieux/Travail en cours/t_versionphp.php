...
<body>
    ...
    <div id="add_file_p" class="big_pop_up">
        ...
        <div class="p_content">
            <form id="add_file_f" action="t_send_file.php" method="post" enctype="multipart/form-data">
                ...
                <div id="top">
                    <label for="file_input">fichier:</label><br>
    ...
    <div id="make_obselete_p" class="small_pop_up" id="obselete_pop_up">
        ...
        <div class="p_footer">
            ...
            <button id="validation" onclick="obselete()" type="button">Validation</button>
        </div>
    </div>
    ...
    <div id="create_project_p" class="long_pop_up">
        ...
        <div class="p_footer">
            ...
            <button class="nav_pop" id="validate" onclick="closePopUp()" type="button">Valider</button>
        </div>
    </div>
